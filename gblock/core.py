...
#     def __init__(self, attr = '', state = '', value = 0, optional = False):
#         self.attr = attr
#         self.state = state
#         self.value = value
...
#     def __str__(self):
#         return '{}.{}.{}'.format(self.attr, self.state, self.value)

#     def set_all(self, attr = None, state = None, value = None):
...
#     def valid(self):
#         return (self.optional ) or ((self.attr != '') and (self.state != '') and (self.value != 0))

#     def read_from_str(self, string, sep = ':'):
#         st = string.split(sep)

#         try:
#             self.set_all(attr = st[0], state = st[1], value = float(st[0]))
#             return True
#         except:
#             self.set_all()
#             raise ValueError('Unable to read from string')
#             return False
